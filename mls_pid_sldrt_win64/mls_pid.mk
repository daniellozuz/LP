...
MODEL                := mls_pid
MODULES              := mls_pid_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             := mls_pid.mk
...
#
MODELLIB                  := mls_pidlib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := mls_pid_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;E:/MATLAB_WORK/LaboratoriumProblemowe/LP/mls_pid_sldrt_win64;E:/MATLAB_WORK/LaboratoriumProblemowe/LP;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
